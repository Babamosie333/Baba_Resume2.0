...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "features.ai.subtitle": "We provide an all-in-one resume solution to make your job search journey smoother",
    "features.ai.smart.title": "Smart Detection, Professional Advice",
    "features.ai.smart.desc": "Built-in smart grammar check, automatically identifies inappropriate expressions, provides professional modification suggestions, making your resume more outstanding.",
