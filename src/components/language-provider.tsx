...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "builder.availability": "Working Days / Availability",
    "builder.summary": "Professional Summary",
    "builder.summaryPlaceholder": "Briefly describe your career background...",
    "builder.duration": "Duration",
    "builder.durationPlaceholder": "Jan 2020 - Present",
    "builder.projectDescPlaceholder": "Describe the project achievements and tech stack...",
    "builder.githubContributions": "GitHub Contributions (Simulated)",
    "builder.skillPlaceholder": "Skill",
    "builder.languagePlaceholder": "Language",
    "builder.photo": "Photo",
    "builder.fullNamePlaceholder": "John Doe",
    "builder.availabilityPlaceholder": "Available / Mon - Fri, 9 AM - 6 PM",
    "builder.emailPlaceholder": "john@example.com",
    "builder.phonePlaceholder": "+1 234 567 890",
    "builder.locationPlaceholder": "New York, USA",
    "builder.companyPlaceholder": "Company Name",
    "builder.rolePlaceholder": "Role / Title",
    "builder.schoolPlaceholder": "University Name",
    "builder.degreePlaceholder": "Degree Name",
    "builder.yearPlaceholder": "2020 - 2024",
      "builder.projectNamePlaceholder": "Project Name",
      "builder.projectLinkPlaceholder": "https://github.com/...",
      "builder.decreaseFontSize": "Decrease Font Size",
      "builder.increaseFontSize": "Increase Font Size",
      "templates.title": "Choose Your Template",
      "templates.subtitle": "Our professionally designed templates are tested to impress recruiters.",
    "templates.useThis": "Use This",
    "pricing.title": "Simple, Transparent Pricing",
    "pricing.subtitle": "Choose the perfect plan for your career stage.",
    "pricing.free": "Free",
    "pricing.pro": "Pro",
    ...
    "features.security.description": "All resume data is stored completely locally, no need to worry about privacy leaks.",
    "features.security.local": "Local File Storage",
    "features.security.export": "Multiple Export Formats",
    "features.ai.badge": "AI",
    "features.ai.title": "Why Choose Baba_Resume2.0?",
    "features.ai.subtitle": "We provide an all-in-one resume solution to make your job search journey easier",
    "features.ai.smart.title": "Smart Detection, Professional Advice",
    "features.ai.smart.desc": "Built-in smart grammar check, automatically identifying inappropriate expressions, providing professional revision suggestions, making your resume even more outstanding.",
    "features.ai.item1": "Intelligent Enhancement",
    "features.ai.item2": "Grammar Check",
    "faq.title": "Frequently Asked Questions",
    "faq.q1": "Is Baba_Resume2.0 free to use?",
    "faq.a1": "Yes, Baba_Resume2.0 is completely free to use.",
    "faq.q2": "Is my resume data safe?",
    "faq.a2": "Security is our top priority. All your resume data is stored locally.",
    "faq.q3": "What export formats are supported?",
    "faq.a3": "Currently, we support high-quality PDF exports.",
    "faq.q4": "How can I sync across different devices?",
    "faq.a4": "Since we prioritize privacy, automatic syncing is not enabled. Use 'Data Export' to move files.",
    ...
    "about.missionDesc": "To empower job seekers with smart, accessible tools to create professional resumes and land their dream jobs.",
    "about.story1": "Baba_Resume2.0 was born out of a simple observation: the traditional process of resume building is often tedious, confusing, and technically demanding. We set out to create a platform that leverages modern technology to make this process seamless and enjoyable.",
    "about.story2": "Our platform uses advanced AI to help users articulate their achievements, while our clean, modern templates ensure the final result is always professional and ATS-friendly. Best of all, we've designed everything with a 'privacy-first' mindset, meaning your sensitive data is always handled with the utmost care.",
    ...
    "about.accessibilityDesc": "We believe everyone deserves a professional resume, regardless of their technical skills.",
  ...
  hi: {
    ...
    "builder.availability": "कार्य दिवस / उपलब्धता",
    "builder.summary": "प्रोफेशनल सारांश",
    "builder.summaryPlaceholder": "संक्षेप में अपने करियर की पृष्ठभूमि का वर्णन करें...",
    "builder.duration": "अवधि",
    "builder.durationPlaceholder": "जनवरी 2020 - वर्तमान",
    "builder.projectDescPlaceholder": "परियोजना की उपलब्धियों और टेक स्टैक का वर्णन करें...",
    "builder.githubContributions": "गिटहब योगदान (सिम्युलेटेड)",
    "builder.skillPlaceholder": "कौशल",
    "builder.languagePlaceholder": "भाषा",
    "builder.photo": "फोटो",
    "builder.fullNamePlaceholder": "जॉन डो",
    "builder.availabilityPlaceholder": "उपलब्ध / सोम - शुक्र, सुबह 9 बजे - शाम 6 बजे",
    "builder.emailPlaceholder": "john@example.com",
    "builder.phonePlaceholder": "+91...",
    "builder.locationPlaceholder": "कानपुर, भारत",
    "builder.companyPlaceholder": "कंपनी का नाम",
    "builder.rolePlaceholder": "भूमिका / पद",
    "builder.schoolPlaceholder": "विश्वविद्यालय का नाम",
    "builder.degreePlaceholder": "डिग्री का नाम",
    "builder.yearPlaceholder": "2020 - 2024",
    "builder.projectNamePlaceholder": "परियोजना का नाम",
    "builder.projectLinkPlaceholder": "https://github.com/...",
    ...
    "features.advice.desc": "अपने रिज्यूमे की सामग्री को बेहतर बनाने के लिए रीयल-टाइम फीडैक और प्रोफेशनल टिप्स प्राप्त करें।",
    ...
    "features.ai.badge": "AI",
    "features.ai.title": "Baba_Resume2.0 क्यों चुनें?",
    "features.ai.subtitle": "हम आपकी नौकरी खोज यात्रा को आसान बनाने के लिए एक ऑल-इन-वन रिज्यूमे समाधान प्रदान करते हैं",
    "features.ai.smart.title": "स्मार्ट डिटेक्शन, प्रोफेशनल सलाह",
    "features.ai.smart.desc": "अंतर्निहित स्मार्ट व्याकरण जाँच, स्वचालित रूप से अनुचित अभिव्यक्तियों की पहचान करती है, पेशेवर संशोधन सुझाव प्रदान करती है, जिससे आपका रिज्यूमे और भी शानदार बन जाता है।",
    "features.ai.item1": "बुद्धिमान वृद्धि",
    "features.ai.item2": "व्याकरण जाँच",
