    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-32 pb-24 px-4">
        <div className="max-w-[800px] mx-auto prose prose-zinc">
          <h1 className="text-4xl font-bold text-[#030712] mb-8">Privacy Policy</h1>
          <p className="text-muted-foreground mb-6">Last updated: May 20, 2024</p>
          
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-[#030712] mb-4">1. Introduction</h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-[#030712] mb-4">2. Data We Collect</h2>
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-[#030712] mb-4">3. How We Use Your Data</h2>
            <p className="text-zinc-600 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-[#030712] mb-4">4. Cookies</h2>
            <p className="text-zinc-600 leading-relaxed">
          ...
          <section className="mb-10">
            <h2 className="text-2xl font-bold text-[#030712] mb-4">5. Contact Us</h2>
            <p className="text-zinc-600 leading-relaxed">
